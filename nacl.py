...
def keygen(sk_file=None, pk_file=None, **kwargs):
    ...
    if sk_file is None:
        ...
        return {
            "sk": salt.utils.stringutils.to_str(base64.b64encode(kp.encode())),
            "pk": salt.utils.stringutils.to_str(
                base64.b64encode(kp.public_key.encode())
            ),
        }
...
def sealedbox_encrypt(data, **kwargs):
    ...
    return salt.utils.stringutils.to_str(base64.b64encode(b.encrypt(data)))
...
def sealedbox_decrypt(data, **kwargs):
    ...
    b = nacl.public.SealedBox(keypair)
    return salt.utils.stringutils.to_str(b.decrypt(base64.b64decode(data)))
