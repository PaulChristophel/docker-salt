https://it.github.gatech.edu/epi/docker-salt/actions/workflows/latest.yaml[image:https://it.github.gatech.edu/epi/docker-salt/actions/workflows/latest.yaml/badge.svg[Latest
Release]]
