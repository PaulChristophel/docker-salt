...
COPY app.py /usr/local/salt/lib/python3.12/site-packages/salt/netapi/rest_cherrypy/
# COPY sitecustomize.py /usr/local/salt/lib/python3.12/site-packages/
# RUN if [[ $REQUIREMENTS != *"3006"* ]]; then rm -fv /usr/local/salt/lib/python3.12/site-packages/sitecustomize.py; fi
